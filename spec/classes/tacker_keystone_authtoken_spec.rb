...
describe 'tacker::keystone::authtoken' do
  ...
  shared_examples 'tacker::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('tacker_config').with(
          :username                       => 'tacker',
          :password                       => 'tacker_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'tacker::keystone::authtoken'
    end
  end
