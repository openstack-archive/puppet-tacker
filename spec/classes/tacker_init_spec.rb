  ...
  shared_examples 'tacker' do
    ...
    context 'with default parameters' do
      ...
      it 'configures rabbit' do
        ...
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_host').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_password').with_value('<SERVICE DEFAULT>').with_secret(true)
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_port').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_userid').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_virtual_host').with_value('<SERVICE DEFAULT>')
    ...
    context 'with overridden parameters' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_tacker_config('DEFAULT/rpc_backend').with_value('rabbit')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_host').with_value('rabbit')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_password').with_value('password').with_secret(true)
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_port').with_value('5673')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_userid').with_value('rabbit_user')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_virtual_host').with_value('<SERVICE DEFAULT>')
    ...
    context 'with rabbit_hosts parameter' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_host').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_port').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_hosts').with_value('rabbit:5673,rabbit2:5674')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_ha_queues').with_value(true)
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_use_ssl').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_reconnect_delay').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/amqp_durable_queues').with_value('<SERVICE DEFAULT>')
      end
    end
    ...
    context 'with rabbit_hosts parameter (one server)' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_host').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_port').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_hosts').with_value('rabbit:5673')
    ...
    context 'with rabbit ssl enabled with kombu' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_use_ssl').with_value(true)
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_ca_certs').with_value('/etc/ca.cert')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_certfile').with_value('/etc/certfile')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_keyfile').with_value('/etc/key')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_version').with_value('TLSv1')
      end
    end
    ...
    context 'with rabbit ssl enabled without kombu' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/rabbit_use_ssl').with_value(true)
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_ca_certs').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_certfile').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_keyfile').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_tacker_config('oslo_messaging_rabbit/kombu_ssl_version').with_value('<SERVICE DEFAULT>')
      end
    end
    ...
    context 'with amqp rpc_backend' do
      ...
      context 'with default parameters' do
        it 'configures amqp' do
          is_expected.to contain_tacker_config('DEFAULT/rpc_backend').with_value('amqp')
